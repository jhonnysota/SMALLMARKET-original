...
namespace Negocio.Generales
{
    public class UMedidaLN
    {
        ...
        public UMedidaE InsertarUMedida(UMedidaE umedida)
        {
            try
            {
                return new UMedidaAD().InsertarUMedida(umedida);
            }
        ...
        public UMedidaE ActualizarUMedida(UMedidaE umedida)
        {
            try
            {
                return new UMedidaAD().ActualizarUMedida(umedida);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public Int32 EliminarUMedida(Int32 idUMedida)
        {
            try
            {
                return new UMedidaAD().EliminarUMedida(idUMedida);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<UMedidaE> ListarUMedida(string NomUMedida)
        {
            try
            {
                return new UMedidaAD().ListarUMedida(NomUMedida);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public UMedidaE ObtenerUMedida(Int32 idUMedida)
        {
            try
            {
                return new UMedidaAD().ObtenerUMedida(idUMedida);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
