...
{
    public class ClienteAvalLN
    {
        public ClienteAvalE InsertarClienteAval(ClienteAvalE clienteaval)
        {
            try
            {
                return new ClienteAvalAD().InsertarClienteAval(clienteaval);
            }
        ...
        public ClienteAvalE ActualizarClienteAval(ClienteAvalE clienteaval)
        {
            try
            {
                return new ClienteAvalAD().ActualizarClienteAval(clienteaval);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int EliminarClienteAval(Int32 idEmpresa, Int32 idPersona)
        {
            try
            {
                return new ClienteAvalAD().EliminarClienteAval(idEmpresa, idPersona);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<ClienteAvalE> ListarClienteAval(Int32 idEmpresa, Int32 idPersona)
        {
            try
            {
                return new ClienteAvalAD().ListarClienteAval(idEmpresa, idPersona);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public ClienteAvalE ObtenerClienteAval(Int32 idEmpresa, Int32 idPersona, Int32 idAval)
        {
            try
            {
                return new ClienteAvalAD().ObtenerClienteAval(idEmpresa, idPersona, idAval);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
