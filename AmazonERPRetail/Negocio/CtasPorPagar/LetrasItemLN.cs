...
namespace Negocio.CtasPorPagar
{
    public class LetrasItemLN 
    {
        ...
        public LetrasItemE InsertarLetrasItem(LetrasItemE letrasitem)
        {
            try
            {
                return new LetrasItemAD().InsertarLetrasItem(letrasitem);
            }
        ...
        public LetrasItemE ActualizarLetrasItem(LetrasItemE letrasitem)
        {
            try
            {
                return new LetrasItemAD().ActualizarLetrasItem(letrasitem);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<LetrasItemE> ListarLetrasItem(Int32 idCanje)
        {
            try
            {
                return new LetrasItemAD().ListarLetrasItem(idCanje);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public LetrasItemE ObtenerLetrasItem(Int32 idEmpresa, Int32 idLocal, Int32 idCanje, Int32 idItemLetra)
        {
            try
            {
                return new LetrasItemAD().ObtenerLetrasItem(idEmpresa, idLocal, idCanje, idItemLetra);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
