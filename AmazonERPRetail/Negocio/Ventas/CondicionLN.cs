...
{
    public class CondicionLN
    {
        public CondicionE InsertarCondicion(CondicionE condicion)
        {
            try
            {
                return new CondicionAD().InsertarCondicion(condicion);
            }
        ...
        public CondicionE ActualizarCondicion(CondicionE condicion)
        {
            try
            {
                return new CondicionAD().ActualizarCondicion(condicion);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<CondicionE> ListarCondicionPorTipo(Int32 idTipCondicion)
        {
            try
            {
                return new CondicionAD().ListarCondicionPorTipo(idTipCondicion);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public CondicionE ObtenerCondicion(Int32 idTipCondicion, Int32 idCondicion)
        {
            try
            {
                return new CondicionAD().ObtenerCondicion(idTipCondicion, idCondicion);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int EliminarCondicion(Int32 idTipCondicion)
        {
            try
            {
                return new CondicionAD().EliminarCondicion(idTipCondicion);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
