...
{
    public class comisionLN //: BaseLN
    {
        public comisionE Insertarcomision(comisionE comision)
        {
            try
            {
                return new comisionAD().Insertarcomision(comision);
            }
        ...
        public comisionE Actualizarcomision(comisionE comision)
        {
            try
            {
                return new comisionAD().Actualizarcomision(comision);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int Eliminarcomision(Int32 idEmpresa, Int32 idPeriodo, Int32 idVendedor)
        {
            try
            {
                return new comisionAD().Eliminarcomision(idEmpresa, idPeriodo, idVendedor);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<comisionE> Listarcomision()
        {
            try
            {
                return new comisionAD().Listarcomision();
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public comisionE Obtenercomision(Int32 idEmpresa, Int32 idPeriodo, Int32 idVendedor)
        {
            try
            {
                return new comisionAD().Obtenercomision(idEmpresa, idPeriodo, idVendedor);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<comisionE> ResumenComisiones(Int32 idEmpresa, Int32 idPeriodo)
        {
            try
            {
                return new comisionAD().ResumenComisiones(idEmpresa, idPeriodo);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
