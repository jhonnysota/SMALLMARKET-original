...
{
    public class comisionPagoLN 
    {
        public comisionPagoE InsertarcomisionPago(comisionPagoE comisionpago)
        {
            try
            {
                return new comisionPagoAD().InsertarcomisionPago(comisionpago);
            }
        ...
        public comisionPagoE ActualizarcomisionPago(comisionPagoE comisionpago)
        {
            try
            {
                return new comisionPagoAD().ActualizarcomisionPago(comisionpago);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int EliminarcomisionPago(Int32 idEmpresa, Int32 idCalculo)
        {
            try
            {
                return new comisionPagoAD().EliminarcomisionPago(idEmpresa, idCalculo);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<comisionPagoE> ListarcomisionPago()
        {
            try
            {
                return new comisionPagoAD().ListarcomisionPago();
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public comisionPagoE ObtenercomisionPago(Int32 idEmpresa, Int32 idCalculo)
        {
            try
            {
                return new comisionPagoAD().ObtenercomisionPago(idEmpresa, idCalculo);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
