...
{
    public class LineaCreditoLN 
    {
        public LineaCreditoE InsertarLineaCredito(LineaCreditoE lineacredito)
        {
            try
            {
                return new LineaCreditoAD().InsertarLineaCredito(lineacredito);
            }
        ...
        public LineaCreditoE ActualizarLineaCredito(LineaCreditoE lineacredito)
        {
            try
            {
                return new LineaCreditoAD().ActualizarLineaCredito(lineacredito);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int EliminarLineaCredito(Int32 idPersona, Int32 idEmpresa, Int32 item)
        {
            try
            {
                return new LineaCreditoAD().EliminarLineaCredito(idPersona, idEmpresa, item);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<LineaCreditoE> ListarLineaCredito()
        {
            try
            {
                return new LineaCreditoAD().ListarLineaCredito();
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public LineaCreditoE ObtenerLineaCredito(Int32 idPersona, Int32 idEmpresa, Int32 item)
        {
            try
            {
                return new LineaCreditoAD().ObtenerLineaCredito(idPersona, idEmpresa, item);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
