...
{
    public class SolicitudProveedorDetLN
    {
        ...
        public SolicitudProveedorDetE InsertarSolicitudProveedorDet(SolicitudProveedorDetE solicitudproveedordet)
        {
            try
            {
                return new SolicitudProveedorDetAD().InsertarSolicitudProveedorDet(solicitudproveedordet);
            }
        ...
        public SolicitudProveedorDetE ActualizarSolicitudProveedorDet(SolicitudProveedorDetE solicitudproveedordet)
        {
            try
            {
                return new SolicitudProveedorDetAD().ActualizarSolicitudProveedorDet(solicitudproveedordet);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int EliminarSolicitudProveedorDet(Int32 idSolicitud, Int32 Item)
        {
            try
            {
                return new SolicitudProveedorDetAD().EliminarSolicitudProveedorDet(idSolicitud, Item);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<SolicitudProveedorDetE> ListarSolicitudProveedorDet(Int32 idSolicitud)
        {
            try
            {
                return new SolicitudProveedorDetAD().ListarSolicitudProveedorDet(idSolicitud);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public SolicitudProveedorDetE ObtenerSolicitudProveedorDet(Int32 idSolicitud, Int32 Item)
        {
            try
            {
                return new SolicitudProveedorDetAD().ObtenerSolicitudProveedorDet(idSolicitud, Item);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
