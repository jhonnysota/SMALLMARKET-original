...
namespace Negocio.Tesoreria
{
    public class tesParametrosLN
    {
        ...
        public tesParametrosE InsertarTesParametros(tesParametrosE parametros)
        {
            try
            {
                return new tesParametrosAD().InsertarTesParametros(parametros);
            }
        ...
        public tesParametrosE ActualizarTesParametros(tesParametrosE parametros)
        {
            try
            {
                return new tesParametrosAD().ActualizarTesParametros(parametros);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int EliminarTesParametros(Int32 idEmpresa)
        {
            try
            {
                return new tesParametrosAD().EliminarTesParametros(idEmpresa);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<tesParametrosE> ListarTesParametros()
        {
            try
            {
                return new tesParametrosAD().ListarTesParametros();
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public tesParametrosE ObtenerTesParametros(Int32 idEmpresa)
        {
            try
            {
                return new tesParametrosAD().ObtenerTesParametros(idEmpresa);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
