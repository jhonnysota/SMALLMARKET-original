...
{
    public class LibroConcarLN 
    {
        public LibroConcarE Insertarlibroconcar(LibroConcarE libroconcar)
        {
            try
            {
                return new LibroConcarAD().Insertarlibroconcar(libroconcar);
            }
        ...
        public LibroConcarE Actualizarlibroconcar(LibroConcarE libroconcar)
        {
            try
            {
                return new LibroConcarAD().Actualizarlibroconcar(libroconcar);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int Eliminarlibroconcar(Int32 idEmpresa, String csubdia)
        {
            try
            {
                return new LibroConcarAD().Eliminarlibroconcar(idEmpresa, csubdia);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<LibroConcarE> Listarlibroconcar(Int32 idEmpresa)
        {
            try
            {
                return new LibroConcarAD().Listarlibroconcar(idEmpresa);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public LibroConcarE Obtenerlibroconcar(Int32 idEmpresa, String csubdia)
        {
            try
            {
                return new LibroConcarAD().Obtenerlibroconcar(idEmpresa, csubdia);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
