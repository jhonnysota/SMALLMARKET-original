...
{
    public class CorrelativoLN //: BaseLN
    {
        public CorrelativoE InsertarCorrelativo(CorrelativoE correlativo)
        {
            try
            {
                return new CorrelativoAD().InsertarCorrelativo(correlativo);
            }
        ...
        public CorrelativoE ActualizarCorrelativo(CorrelativoE correlativo)
        {
            try
            {
                return new CorrelativoAD().ActualizarCorrelativo(correlativo);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int EliminarCorrelativo(Int32 idEmpresa, Int32 idCorrelativo)
        {
            try
            {
                return new CorrelativoAD().EliminarCorrelativo(idEmpresa, idCorrelativo);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<CorrelativoE> ListarCorrelativo()
        {
            try
            {
                return new CorrelativoAD().ListarCorrelativo();
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public CorrelativoE ObtenerCorrelativo(Int32 idEmpresa, Int32 idCorrelativo)
        {
            try
            {
                return new CorrelativoAD().ObtenerCorrelativo(idEmpresa, idCorrelativo);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
