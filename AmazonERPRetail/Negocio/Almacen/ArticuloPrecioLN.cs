...
namespace Negocio.Almacen
{
    public class ArticuloPrecioLN
    {
        ...
        public ArticuloPrecioE InsertarArticuloPrecio(ArticuloPrecioE articuloprecio)
        {
            try
            {
                return new ArticuloPrecioAD().InsertarArticuloPrecio(articuloprecio);
            }
        ...
        public ArticuloPrecioE ActualizarArticuloPrecio(ArticuloPrecioE articuloprecio)
        {
            try
            {
                return new ArticuloPrecioAD().ActualizarArticuloPrecio(articuloprecio);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int EliminarArticuloPrecio(Int32 idEmpresa, Int32 idArticulo)
        {
            try
            {
                return new ArticuloPrecioAD().EliminarArticuloPrecio(idEmpresa, idArticulo);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public List<ArticuloPrecioE> ListarArticuloPrecio(Int32 idEmpresa)
        {
            try
            {
                return new ArticuloPrecioAD().ListarArticuloPrecio(idEmpresa);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public ArticuloPrecioE ObtenerArticuloPrecio(Int32 idEmpresa, Int32 idArticulo)
        {
            try
            {
                return new ArticuloPrecioAD().ObtenerArticuloPrecio(idEmpresa, idArticulo);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
