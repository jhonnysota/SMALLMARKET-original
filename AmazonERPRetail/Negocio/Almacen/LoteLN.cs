...
namespace Negocio.Almacen
{
    public class LoteLN
    {
        ...
        public LoteE InsertarLote(LoteE Lote)
        {
            try
            {
                return new LoteAD().InsertarLote(Lote);
            }
        ...
        public LoteE ActualizarLote(LoteE Lote)
        {
            try
            {
                return new LoteAD().ActualizarLote(Lote);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public int EliminarLote(Int32 idEmpresa, String Lote)
        {
            try
            {
                return new LoteAD().EliminarLote(idEmpresa,Lote);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public LoteE ObtenerLote(Int32 idEmpresa, String Lote,Int32 idAlmacen)
        {
            try
            {
                return new LoteAD().ObtenerLote(idEmpresa, Lote, idAlmacen);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public LoteE ObtenerPorLote(String Lote, Int32 idAlmacen)
        {
            try
            {
                return new LoteAD().ObtenerPorLote( Lote, idAlmacen);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public String ObtenerMaxLoteAlmacen(Int32 idEmpresa)
        {
            try
            {
                return new LoteAD().ObtenerMaxLoteAlmacen(idEmpresa);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public String ObtenerMaxLoteAlmacenInterno(Int32 idEmpresa)
        {
            try
            {
                return new LoteAD().ObtenerMaxLoteAlmacenInterno(idEmpresa);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
        ...
        public LoteE BuscarLoteExistente(Int32 idEmpresa, String Lote)
        {
            try
            {
                return new LoteAD().BuscarLoteExistente(idEmpresa, Lote);
            }
            catch (SqlException ex)
            {
                SqlError err = ex.Errors[0];
