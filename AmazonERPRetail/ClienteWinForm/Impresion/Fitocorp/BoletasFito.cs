...
namespace ClienteWinForm.Impresion.Fitocorp
{
    public class BoletasFito
    {
        ...
        public void AgregarItems(String ItemTexto)
        {
            ...
            Items[ContadorItems, 1] = "187";// Eje x
            Items[ContadorItems, 2] = "71"; // Eje y
            ...
            DivideItemDet2(itemsDatos[2].Length, DigitosArt2, itemsDatos[2]);
        ...
        private void DivideItemDet2(Int32 lenghtDet, Int32 maxCharDet, String detalleText)
        {
            if (lenghtDet > maxCharDet)
            {
                ...
                while (i < splitDetalle.Length)
                {
                    ...
                    if (ContadorLineas < 1)
                    {
                        ...
                        Items[ContadorItems, 1] = "70";// Eje x
                        Items[ContadorItems, 2] = "71";// Eje y
                        ContadorLineas++;
                        Linea = String.Empty;
                    }
