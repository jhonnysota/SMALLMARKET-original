...
namespace ClienteWinForm.Impresion.Fitocorp
{
    public class LetrasFito
    {
        ...
        String nomLetra = String.IsNullOrWhiteSpace(VariablesLocales.oVenParametros.FontPrintLetra.Trim()) ? "Lucida Console" : VariablesLocales.oVenParametros.FontPrintLetra;
        Int32 tamLetra = VariablesLocales.oVenParametros.SizeFontLetra == 0 ? 9 : VariablesLocales.oVenParametros.SizeFontLetra;//9;
        Graphics gfx = null;
        ...
        public void AgregarItems(String ItemTexto, Int32 cantCaracteres)
        {
            ...
            Items[ContadorItems, 2] = "97"; // Eje y
            //Precio Unitario
            ContadorItems++;
        ...
        public void ImprimirLetra(String Impresora)
        {
            ...
            oPrint.DocumentName = "Impresion de Letra";
            oPrint.PrintPage += new PrintPageEventHandler(pr_PrintPage);
            Margins margins = new Margins(10, 10, 100, 100);
            oPrint.DefaultPageSettings.Margins = margins;
            oPrint.Print();
        }
