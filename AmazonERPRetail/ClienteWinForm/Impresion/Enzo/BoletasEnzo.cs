...
namespace ClienteWinForm.Impresion.Enzo
{
    public class BoletasEnzo
    {
        ...
        public void AgregarItems(String ItemTexto)
        {
            ...
            Items[ContadorItems, 2] = "46.5"; // Eje y
        ...
        private void DrawItems()
        {
            for (Int32 i = 0; i < ContadorItems; i++)
            {
                ...
                if (Contador == 5)
                {
                    posItemsY += 6; //incremento en 6 milimitros para la proxima linea
                    Contador = 0;
                }
        ...
        private void DivideItemDet(Int32 lenghtDet, Int32 maxCharDet, String detalleText)
        {
            ...
            else
            {
                ...
                Items[ContadorItems, 1] = "16.5";// Eje x
                Items[ContadorItems, 2] = "46";// Eje y
            }
        }
