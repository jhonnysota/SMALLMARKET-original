...
namespace ClienteWinForm.Impresion.SCIngenieros
{
    public class FacturaSC
    {
        ...
        String nomLetra = String.IsNullOrWhiteSpace(VariablesLocales.oVenParametros.LetraImpresion.Trim()) ? "Verdana" : VariablesLocales.oVenParametros.LetraImpresion;
        Int32 tamLetra = VariablesLocales.oVenParametros.SizeLetra == 0 ? 9 : VariablesLocales.oVenParametros.SizeLetra;//9;
        Graphics gfx = null;
            ...
            if (lenghtDet > maxCharDet)
            {
                ...
                while (i < splitDetalle.Length)
                {
                    ...
                    if (ContadorLineas < 1)
                    {
                        ...
                        Items[ContadorItems, 1] = "32";// Eje x
                        Items[ContadorItems, 2] = "75";// Eje y
                        ContadorLineas++;
                        Linea = String.Empty;
                    }
