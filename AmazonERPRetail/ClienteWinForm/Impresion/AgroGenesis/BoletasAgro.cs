            ...
            if (lenghtDet > maxCharDet)
            {
                ...
                while (i < splitDetalle.Length)
                {
                    ...
                    if (ContadorLineas < 1)
                    {
                        ...
                        Items[ContadorItems, 1] = "36";// Eje x
                        Items[ContadorItems, 2] = "81";// Eje y
                        ContadorLineas++;
                        Linea = String.Empty;
                    }
