...
{
    public class ImpresionJeri : IImpresion
    {
        ...
        private void Facturas(EmisionDocumentoE oFactura, String nomImpresora)
        {
            ...
            FacturasJeri oFacturaImpresion = new FacturasJeri();
            String NombreArticulo = String.Empty;
            ...
            if (oFactura.ListaCanjeGuias != null && oFactura.ListaCanjeGuias.Count > 0)
            {
                ...
                oFacturaImpresion.AgregarDatos(CadenaGuias.ToString().Trim(), "45", "90"); //guias
            }
            else
            {
        ...
        private void BoletaVenta(EmisionDocumentoE oBoleta, String nomImpresora)
        {
            ...
            if (oBoleta.desCondicion.Contains("TRANSFERENCIA"))
            {
                oBoletaImpresion.AgregarDatos(oMoneda.desAbreviatura + " 0.00", "179", "244");
                oBoletaImpresion.AgregarDatos(enLetras("0.00") + Moneda, "31", "259");
            }
            else
            {
                oBoletaImpresion.AgregarDatos(oMoneda.desAbreviatura + "  " + oBoleta.totTotal.ToString("N2"), "179", "244");
                ////Total en Letras
        ...
        private void NotaDeDebitoND(EmisionDocumentoE oNotaDebito, String nomImpresora)
        {
            ...
            if (oNotaDebito.desCondicionRef.Contains("TRANSFERENCIA"))
            {
                ...
                oNdImpresion.AgregarDatos(oMoneda.desAbreviatura + " " + Numeros, "183", "132");
                ...
                oNdImpresion.AgregarDatos(oMoneda.desAbreviatura + " " + Numeros, "183", "138.5");
                Numeros = oNdImpresion.AlinearDerecha("0.00".Length, 6) + "0.00";
                oNdImpresion.AgregarDatos(oMoneda.desAbreviatura + " " + Numeros, "183", "144");
            }
            else
            {
                //Total en Letras
