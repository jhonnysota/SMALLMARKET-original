...
{
    public class FacturasInter
    {

        #region Constructor

        public FacturasInter()
        {
        ...
        public void AgregarItems(String ItemTexto)
        {
            ...
            Items[ContadorItems, 1] = "19"; // Eje x
            Items[ContadorItems, 2] = "82"; // Eje y
            ContadorItems++;

            // Cantidad
            Items[ContadorItems, 0] = AlinearDerecha(itemsDatos[2].Length, DigitosCant) + itemsDatos[2];
            Items[ContadorItems, 1] = "30"; // Eje x
            Items[ContadorItems, 2] = "82"; // Eje y
            ContadorItems++;

            // Precio Unitario
            Items[ContadorItems, 0] = AlinearDerecha(itemsDatos[4].Length, DigitosPu) + itemsDatos[4];
            Items[ContadorItems, 1] = "122"; // Eje x
            Items[ContadorItems, 2] = "82"; // Eje y
            ContadorItems++;

            // Subtotal
            Items[ContadorItems, 0] = AlinearDerecha(itemsDatos[5].Length, DigitosImporte) + itemsDatos[5];
            Items[ContadorItems, 1] = "145";// Eje x
            Items[ContadorItems, 2] = "82"; // Eje y
            ContadorItems++;

            // Total
            Items[ContadorItems, 0] = AlinearDerecha(itemsDatos[6].Length, DigitosImporte) + itemsDatos[6];
            Items[ContadorItems, 1] = "174";// Eje x
            Items[ContadorItems, 2] = "82"; // Eje y
