...
namespace ClienteWinForm.Impresion.Intermetal
{
    public class GuiasFfs
    {
        ...
        {
            PrinterSettings oImpresora = new PrinterSettings();
            
            //printFont = new Font(fontName, fontSize, FontStyle.Regular);
            PrintDocument oPrint = new PrintDocument();
            oImpresora = oPrint.PrinterSettings;
            oImpresora.PrinterName = Impresora;
            //oImpresora.
        ...
        private void DivideItemDetEnter(Int32 lenghtDet, Int32 maxCharDet, String detalleText)
        {
            ...
            foreach (string item in listaTextoP)
            {
                ...
                else
                {
                    ...
                    DivideItemDet(item.Length, maxCharDet, item); // Descripción
