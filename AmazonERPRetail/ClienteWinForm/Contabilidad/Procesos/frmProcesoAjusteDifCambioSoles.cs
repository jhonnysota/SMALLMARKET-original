...
{
    public partial class frmProcesoAjusteDifCambioSoles : FrmMantenimientoBase
    {

        public frmProcesoAjusteDifCambioSoles()
        {
        ...
        void CargarDatos(string Credenciales)
        {
            ...
            oListaPlanCuentasAsignadas = AgenteContabilidad.Proxy.ObtenerPlanCuentasDifCambioUsuarioSoles(idEmpresa, PlanCuenta, Credenciales);
        ...
        void _bw_Dowork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                if (ProcesoActual == "E")
                {
                    ...
                    AgenteContabilidad.Proxy.EliminarDiferenciaCambioSoles(idEmpresa, ano, mes, INCuenta, plan, check, UsuarioAsignado);
                ...
                if (ProcesoActual == "P")
                {
                    ...
                    AgenteContabilidad.Proxy.ProcesoDiferenciaCambioSoles(idEmpresa, ano, mes, INCuenta, plan, check, UsuarioAsignado);
        ...
        private void btProcesar_Click(object sender, EventArgs e)
        {
            ...
            {
                Global.MensajeComunicacion("Debe escoger un Usuario.");
            }
        }
