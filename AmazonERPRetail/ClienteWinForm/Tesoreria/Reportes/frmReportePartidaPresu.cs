...
{
    public partial class frmReportePartidaPresu : FrmMantenimientoBase
    {
        ...
        {
            oListaPartipaPresu = AgenteCtasPorPagar.Proxy.ListarPartidaPresuAgrupadoPorProvisiones(4, txtDesde.Value, txtHasta.Value);
        ...
        private void dgvPivot_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (columnindex >2)
            {
                ...
                oListaDetalle = AgenteCtasPorPagar.Proxy.ListarProvisionesPorPartidaPresu(4, codigo,mes,ano);
                ...
                Form oFrm = Application.OpenForms.Cast<Form>().FirstOrDefault(x => x is frmReportePartidaPresuDetalle);
                ...
                oFrm = new frmReportePartidaPresuDetalle(oListaDetalle, desItem +"  "+ columnName);
