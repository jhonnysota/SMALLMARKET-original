...
{
    public partial class frmReportePartidaPresuDetalle : FrmMantenimientoBase
    {
        int TotalRow = 0;
        string desItem = "";
        List<ProvisionesE> oListaDetalle;

        public frmReportePartidaPresuDetalle()
        {
            InitializeComponent();
        ...
        public frmReportePartidaPresuDetalle(List<ProvisionesE> oListaDetalle_, string desItem_)
            : this()
        {
            desItem = desItem_;
        ...
        void ExportarExcel(String Ruta)
        {
            ...
            TituloGeneral = "Provisiones - "+desItem;
            ...
            using (ExcelPackage oExcel = new ExcelPackage(newFile))
            {
                ...
                if (oHoja != null)
                {
                    ...
                    foreach (ProvisionesE item in oListaDetalle)
                    {
                        ...
                        oHoja.Cells[InicioLinea, 4].Value = item.FechaDocumento;
                        oHoja.Cells[InicioLinea, 5].Value = item.FechaVencimiento;

                        oHoja.Cells[InicioLinea, 6].Value = item.idDocumento;
                        oHoja.Cells[InicioLinea, 7].Value = item.desDocumento;
                        oHoja.Cells[InicioLinea, 8].Value = item.NumSerie;
                        oHoja.Cells[InicioLinea, 9].Value = item.NumDocumento;
                        oHoja.Cells[InicioLinea, 10].Value = item.TipCambio;
                        oHoja.Cells[InicioLinea, 11].Value = item.CodMonedaProvision;

                        oHoja.Cells[InicioLinea, 12].Value = item.impTotalBase;
                        oHoja.Cells[InicioLinea, 13].Value = item.impTotalSecun;

                        oHoja.Cells[InicioLinea, 14].Value = item.EstadoProvision;
                        oHoja.Cells[InicioLinea, 15].Value = item.idComprobante;

                        oHoja.Cells[InicioLinea, 16].Value = item.numFile;
                        oHoja.Cells[InicioLinea, 17].Value = item.numVoucher;
