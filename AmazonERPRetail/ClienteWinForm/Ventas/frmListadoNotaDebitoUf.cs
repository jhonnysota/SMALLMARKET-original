...
{
    public partial class frmListadoNotaDebitoUf : FrmMantenimientoBase
    {

        public frmListadoNotaDebitoUf()
        {
        ...
        List<NumControlDetE> CargarDocumentos()
        {
            List<NumControlDetE> ListaDoc = new List<NumControlDetE>(from x in VariablesLocales.ListaDetalleNumControl
                                                                     where x.Grupo == EnumGrupoDocumentos.D.ToString()
        ...
        public override void Nuevo()
        {
            try
            {
                Form oFrm = Application.OpenForms.Cast<Form>().FirstOrDefault(x => x is frmNotaDebitoUf);
                ...
                {
                    Global.MensajeFault("No se ha configurado ningún item para la Nota de Débito en Control de Documentos.");
                    return;
                }

                oFrm = new frmNotaDebitoUf(oListaNumControlDet)
                {
                    MdiParent = MdiParent
                };
        ...
        public override void Editar()
        {
            try
            {
                if (bsEmisionFacturas.Count > 0)
                {
                    ...
                    if (current != null)
                    {
                        oFrm = new frmNotaDebitoUf(current.idEmpresa, current.idLocal, current.idDocumento, current.numSerie, current.numDocumento, oListaNumControlDet)
                        {
                            MdiParent = MdiParent
                        };
            ...
            try
            {
                if (bsEmisionFacturas.List.Count > 0)
                {
                    if (((EmisionDocumentoE)bsEmisionFacturas.Current).indEstado != EnumEstadoDocumentos.B.ToString())
                    {
                        ...
                        {
                            AgenteVentas.Proxy.CambiarEstadoDocumento(((EmisionDocumentoE)bsEmisionFacturas.Current).idEmpresa, ((EmisionDocumentoE)bsEmisionFacturas.Current).idLocal, ((EmisionDocumentoE)bsEmisionFacturas.Current).idDocumento, ((EmisionDocumentoE)bsEmisionFacturas.Current).numSerie, ((EmisionDocumentoE)bsEmisionFacturas.Current).numDocumento, EnumEstadoDocumentos.B.ToString(), VariablesLocales.SesionUsuario.Credencial);
                    ...
                    {
                        string idDocumentoActual = ((EmisionDocumentoE)bsEmisionFacturas.Current).idDocumento;
                        string SerieActual = ((EmisionDocumentoE)bsEmisionFacturas.Current).numSerie;
                        string NumeroActual = ((EmisionDocumentoE)bsEmisionFacturas.Current).numDocumento;
                        ...
                        if (ControlDetalle != null)
                        {
                            if (idDocumentoActual == ControlDetalle.idDocumento && SerieActual == ControlDetalle.Serie && NumeroActual == ControlDetalle.numCorrelativo)
                            {
                                ...
                                {
                                    Int32 resp = AgenteVentas.Proxy.EliminarEmisDocuCompleto(((EmisionDocumentoE)bsEmisionFacturas.Current).idEmpresa, ((EmisionDocumentoE)bsEmisionFacturas.Current).idLocal, idDocumentoActual, SerieActual, NumeroActual);
        ...
        public override void Imprimir()
        {
            try
            {
                if (bsEmisionFacturas.Count > 0)
                {
                    ...
                    {
                        oFrm = Application.OpenForms.Cast<Form>().FirstOrDefault(x => x is frmNotaDebitoGenesis);
                        ...
                        oFrm = new frmNotaDebitoGenesis(current.idEmpresa, current.idLocal, current.idDocumento, current.numSerie, current.numDocumento);
                    }

                    else if (VariablesLocales.SesionUsuario.Empresa.RUC == "20535703214")//Fitocorp
                    {
                        oFrm = Application.OpenForms.Cast<Form>().FirstOrDefault(x => x is frmNotaDebitoFito);
                        ...
                        oFrm = new frmNotaDebitoFito(current.idEmpresa, current.idLocal, current.idDocumento, current.numSerie, current.numDocumento);
                    }
                    else
                    {
                        oFrm = Application.OpenForms.Cast<Form>().FirstOrDefault(x => x is frmPrevioNotaDebito);
                        ...
                        oFrm = new frmPrevioNotaDebito(current.idEmpresa, current.idLocal, current.idDocumento, current.numSerie, current.numDocumento);
                    }
        ...
        {
            frmNotaDebitoUf oFrm = sender as frmNotaDebitoUf;
        ...
        private void oFrmImpresion_FormClosing(Object sender, FormClosingEventArgs e)
        {
            ...
            {
                frmNotaDebitoFito oFrm = sender as frmNotaDebitoFito;
                ...
                if (oFrm.DialogResult == DialogResult.OK)
                {
                    ...
                    bsEmisionFacturas.ResetBindings(false);
                        ...
                        VariablesLocales.SesionUsuario.Empresa.RUC == "20552690410")   //POWER SEEDS S.A.C)
            {   
                frmNotaDebitoGenesis oFrm = sender as frmNotaDebitoGenesis;
        ...
        private void frmListadoNotaDebitoUf_Load(object sender, EventArgs e)
        {
            ...
            if (bsEmisionFacturas.Count > Variables.Cero)
            {
                ...
                if (((EmisionDocumentoE)bsEmisionFacturas.Current).indEstado == EnumEstadoDocumentos.C.ToString())
                {
                    AgenteVentas.Proxy.CambiarEstadoDocumento(((EmisionDocumentoE)bsEmisionFacturas.Current).idEmpresa, ((EmisionDocumentoE)bsEmisionFacturas.Current).idLocal,
                                ((EmisionDocumentoE)bsEmisionFacturas.Current).idDocumento, ((EmisionDocumentoE)bsEmisionFacturas.Current).numSerie, ((EmisionDocumentoE)bsEmisionFacturas.Current).numDocumento,
        ...
        private void tsmiFactura_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (VariablesLocales.oVenParametros.TipoFacturacion == "B")  //Fundo San Miguel
                {
                    ...
                    Persona oPersona = AgenteMaestro.Proxy.RecuperarPersonaPorID(Convert.ToInt32(((EmisionDocumentoE)bsEmisionFacturas.Current).idPersona));
                    ...
                    if (String.IsNullOrEmpty(((EmisionDocumentoE)bsEmisionFacturas.Current).idDocumentoRef.Trim()) && String.IsNullOrEmpty(((EmisionDocumentoE)bsEmisionFacturas.Current).serDocumentoRef.Trim()))
                    {
        ...
        private void frmListadoNotaDebitoUf_KeyDown(object sender, KeyEventArgs e)
        {
