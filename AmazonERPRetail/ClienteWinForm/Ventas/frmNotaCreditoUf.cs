...
{
    public partial class frmNotaCreditoUf : FrmMantenimientoBase
    {

        #region Constructores

		public frmNotaCreditoUf()
        {
        ...
        //Edición
        public frmNotaCreditoUf(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero, List<NumControlDetE> ListaDetalle)
            : this()
        {
        ...
        //Nuevo
        public frmNotaCreditoUf(List<NumControlDetE> ListaDetalle)
            : this()
        {
            ListaDocumentosControl = new List<NumControlDetE>(ListaDetalle);
        }
        ...
        void LlenarCombos()
        {
            ...
            List<DocumentosE> oListaDocumentosRef = new List<DocumentosE>(from x in VariablesLocales.ListarDocumentoGeneral 
                                                                          ...
                                                                          && x.EsReferencia == true
                                                                          select x).ToList();
            DocumentosE ItemPrimero = new DocumentosE() { idDocumento = Variables.Cero.ToString(), desDocumento = Variables.Seleccione, EsReferencia = true };
            oListaDocumentosRef.Add(ItemPrimero);
            ...
            if (VariablesLocales.oVenParametros.indAfectacionIgv)
            {
        ...
        void ValoresPorDefecto(String Serie)
        {
            ...
            if (Detalle != null)
            {
                ...
                if (Detalle.idCondicion != null && Detalle.idCondicion > Variables.Cero)
                {
                    ...
                    CondicionE tmpCondicion = AgenteVentas.Proxy.ObtenerCondicion((Int32)EnumTipoCondicionVenta.NotaCredito, Convert.ToInt32(Detalle.idCondicion));
        ...
        void DatosGrabacion()
        {
            ...
            {
                DocumentoEmitido.idTipCondicion = (Int32)EnumTipoCondicionVenta.NotaCredito;
            ...
            try
            {
                ...
                if (Validar == Variables.SI)
                {
                    if (idDocumentoRef != EnumTipoDocumentoVenta.LT.ToString() && CambioRef == "S")
                    {
                        ...
                        if (String.IsNullOrWhiteSpace(SerieRef.Trim()))
                        {
                            txtSerieRef.Focus();
                        ...
                        if (String.IsNullOrWhiteSpace(NumeroRef.Trim()))
                        {
                            txtNumDocumentoRef.Focus();
                            Global.MensajeAdvertencia("Ingrese número de referencia");
                            return;
                        }
                        ...
                        if (DocumentoReferencia == null)
                        {
                            ...
                            if (DocumentoReferencia != null)
                            {
                                ...
                                if (VariablesLocales.oVenParametros.indAfectacionIgv)
                                {
                                    if (DocumentoReferencia.tipAfectoIgv != 0)
                                    {
                        ...
                        else
                        {
                            ...
                            {
                                //Momentaneamente...
                                if (Global.MensajeConfirmacion(String.Format("Este documento {0} {1}-{2} ya ha sido referenciado en {3}. Desea continuar?", idDocumentoRef, SerieRef, NumeroRef, DocumentoReferencia.idDocumento + " " + DocumentoReferencia.numSerie + "-" + DocumentoReferencia.numDocumento)) == DialogResult.Yes)
                                {
                                    DocumentoReferencia = AgenteVentas.Proxy.RecuperarDocumentoCompleto(VariablesLocales.SesionUsuario.Empresa.IdEmpresa, VariablesLocales.SesionLocal.IdLocal, idDocumentoRef, SerieRef, NumeroRef);
                                    ...
                                    List<EmisionDocumentoDetE> oListaItems = new List<EmisionDocumentoDetE>();
                                    ...
                                    bsDetalleDocumento.DataSource = DocumentoEmitido.ListaItemsDocumento = oListaItems;
                                    bsDetalleDocumento.ResetBindings(false);
        ...
        public override void Nuevo()
        {
            ...
            else
            {
                ...
                if (VariablesLocales.oVenParametros.indAfectacionIgv)
                {
                    if (DocumentoEmitido.tipAfectoIgv != 0)
                    {
                ...
                Text = "Nota de Crédito (" + DocumentoEmitido.numSerie + "-" + DocumentoEmitido.numDocumento + ")";
        ...
        private void frmNotaCreditoUf_Load(object sender, EventArgs e)
        {
            Grid = false;
            LlenarCombos();
            Nuevo();
            ...
            {
                dgvDetalle.Columns["nroOt"].Visible = true;
                dgvDetalle.Columns["nroOtItem"].Visible = true;
            }
        }
        ...
        private void btBuscarComprobante_Click(object sender, EventArgs e)
        {
            ...
            frmBuscarDocumento oFrm = new frmBuscarDocumento(cboReferencia.SelectedValue.ToString(), dtpFecReferencia.Value.ToString("yyyyMMdd"));
        ...
        private void btBuscarCondicion_Click(object sender, EventArgs e)
        {
            try
            {
                frmBuscarCondicionVentas oFrm = new frmBuscarCondicionVentas(EnumTipoCondicionVenta.NotaCredito);
        ...
        {
            //dtFecEmision_ValueChanged(null, null);
            //dtpFecReferencia.ValueChanged(null, null);
            dtpFecReferencia_ValueChanged(null, null);
        }
