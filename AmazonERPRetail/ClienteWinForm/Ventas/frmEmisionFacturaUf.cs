...
{
    public partial class frmEmisionFacturaUf : FrmMantenimientoBase
    {

        #region Constructores

        public frmEmisionFacturaUf()
        {
        ...
        //Edición
        public frmEmisionFacturaUf(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero, List<NumControlDetE> ListaDetalle)
            : this()
        {
        ...
        //Nuevo
        public frmEmisionFacturaUf(List<NumControlDetE> ListaDetalle)
            : this()
        {
            ListaDocumentosControl = new List<NumControlDetE>(ListaDetalle);
        }
        ...
        String TipodeCalculo = String.Empty;
        ...
        void LlenarCombos()
        {
            ...
            if (VariablesLocales.oVenParametros.indAfectacionIgv) //Empresas con Bizlinks
            {
        ...
        void ValoresPorDefecto(String Serie)
        {
            ...
            if (Detalle != null)
            {
                ...
                DocumentoEmitido.indEstado = Detalle.indEstadoInicial;
        ...
        void DatosGrabacion()
        {
            ...
            DocumentoEmitido.totMontoBruto = Convert.ToDecimal(lblSubTotal.Text);
            ...
            DocumentoEmitido.idTipTransporte = cboTransporte.SelectedValue == null ? "0" : cboTransporte.SelectedValue.ToString();
        ...
        void BloquearControles(Boolean Flag)
        {
            ...
            Bloqueo = Flag;
            btnDistribucionCCostos.Enabled = Flag;
        ...
        {
            if (((EmisionDocumentoDetE)bsDetalleDocumento.Current).tipArticulo == "AN")// || ((EmisionDocumentoDetE)bsDetalleDocumento.Current).tipArticulo == "AA") /// Anticipos...
            {
        ...
        public override void Nuevo()
        {
            ...
            else
            {
                ...
                txtInvoice.Text = DocumentoEmitido.NombrePuerto;
                txtPeriodo.Text = DocumentoEmitido.numReserva;
                txtPo.Text = DocumentoEmitido.numPartida;
                //if (VariablesLocales.SesionUsuario.Empresa.RUC == "20251352292") //Solo Aldeasa...
                //{
                //    txtInvoice.Text = DocumentoEmitido.Invoice;
                //    txtPeriodo.Text = DocumentoEmitido.Periodo;
                //    txtPo.Text = DocumentoEmitido.PO;
                //}
                //else
                //{
                //    txtInvoice.Text = DocumentoEmitido.NombrePuerto;
                ...
                dtpFecVencimiento.Value = string.IsNullOrWhiteSpace(DocumentoEmitido.fecVencimiento) == true ? dtpFecVencimiento.Value : Convert.ToDateTime(DocumentoEmitido.fecVencimiento);
                ...
                Text = "Factura (" + DocumentoEmitido.numSerie + "-" + DocumentoEmitido.numDocumento + ")";
                ...
                txtPais.Text = DocumentoEmitido.desPais;
                txtDep.Text = DocumentoEmitido.desDep;
                txtDis.Text = DocumentoEmitido.desDis;
                txtPro.Text = DocumentoEmitido.desPro;
            ...
            else
            {
                ...
                btNuevoDetalle.Enabled = false;
                btAnticipo.Enabled = false;
                btQuitarAnticipo.Enabled = false;
                btnDistribucionCCostos.Enabled = false;
            ...
            try
            {
                ...
                if (Opcion == Convert.ToInt16(EnumOpcionGrabar.Insertar))
                {
                    if (Global.MensajeConfirmacion(Mensajes.AvisoGrabacion) == DialogResult.Yes)
                    {
                        ...
                        {
                            if (cboEsGuia.SelectedValue.ToString() == "E")
                            {
                                DocumentoEmitido = AgenteVentas.Proxy.GrabarDocumentos(DocumentoEmitido, EnumOpcionGrabar.Insertar, Variables.SI.ToString(), VariablesLocales.SesionUsuario.Empresa.RUC);
                            }
                            else
                            {
                                DocumentoEmitido = AgenteVentas.Proxy.GrabarDocumentos(DocumentoEmitido, EnumOpcionGrabar.Insertar, Variables.SI.ToString(), VariablesLocales.SesionUsuario.Empresa.RUC);
                ...
                else
                {
                    if (Global.MensajeConfirmacion(Mensajes.AvisoActualizacion) == DialogResult.Yes)
                    {
                        if (VariablesLocales.SesionUsuario.Empresa.RUC == "20452630886") //Fundo San Miguel
                        {
                            DocumentoEmitido = AgenteVentas.Proxy.GrabarDocumentos(DocumentoEmitido, EnumOpcionGrabar.Actualizar, Variables.SI, VariablesLocales.SesionUsuario.Empresa.RUC);
                        }
                        else
                        {
        ...
        public override Boolean ValidarGrabacion()
        {
            ...
            if (oPersona != null)
            {
               ...
               if (oTipoDePersoneria.ValorCadena == "NS" )
                {
                    Global.MensajeFault("El cliente no puede ser Natural sin ruc debe hacerle una Boleta de venta.");
                    return false;
                }
            }
            else
            ...
            if (chkAnticipo.Checked)
            {
                foreach (EmisionDocumentoDetE item in DocumentoEmitido.ListaItemsDocumento)
                {
                    ...
                    {
                        Global.MensajeFault(String.Format("Se trata de una factura de anticipo no puede colocar otro tipo de items."));
                        return false;
                    }
                }
            }
        ...
        private void frmEmisionFacturaUf_Load(object sender, EventArgs e)
        {
            try
            {
                Grid = false;
                ...
                //{
                //    btInsertar.Enabled = false;
                //    btArticulos.Visible = false;
                //    btAnticipos.Visible = false;
                //    btServicios.Location = new Point(3, 1);
                //    btEliminarItem.Location = new Point(96, 1);
                //    lblAnticipos.Visible = false;
                //    btAnticipo.Visible = false;
                //    btQuitarAnticipo.Visible = false;
                //    chkAnticipo.Visible = false;
        ...
        private void btBuscarCliente_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (oFrm.ShowDialog() == DialogResult.OK && oFrm.oCliente != null)
                {
                    ...
                    txtPais.Text = oFrm.oCliente.DesPais;
                    txtDep.Text = oFrm.oCliente.DesDep;
                    txtDis.Text = oFrm.oCliente.DesDis;
                    txtPro.Text = oFrm.oCliente.DesPro;
        ...
        private void btBuscarCondicion_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (oFrm.ShowDialog() == DialogResult.OK && oFrm.oCondicion != null)
                {
                    ...
                    if (VariablesLocales.oVenParametros.indAfectacionIgv) // Obligatorio usado en Fundo san miguel y Empresas con Bizlinks
                    { 
                        //if (DocumentoEmitido.idCondicion == 74) // Transferencia Gratuita.
                        //{
        ...
        private void dgvDetalle_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (VariablesLocales.SesionUsuario.Empresa.RUC != "20452630886") //si es diferente al Fundo San Miguel
                {
        ...
        private void btInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //        //    {
                //        //        var agrupado = ListaTmp.GroupBy(x => new { x.idArticulo, x.codArticulo, x.OtroNombre, x.idCalibre, x.idCategoria, x.PesoNeto, x.PesoBruto, x.PrecioUnitario }).Select(group =>
                ...
                //        //            {
                //        //                Item = Correlativo.ToString("000"),
                //        //                idArticulo = op.Key.idArticulo,
                //        //                codArticulo = op.Key.codArticulo,
                //        //                nomArticulo = op.Key.OtroNombre,
                //        //                Cantidad = op.unidxpallet,
                //        //                CantidadAtendida = op.unidxpallet,
                //        //                PrecioSinImpuesto = op.Key.PrecioUnitario
                //        //            };

                //        //            oDetalle.subTotal = Convert.ToDecimal(oDetalle.Cantidad) * oDetalle.PrecioSinImpuesto;
                //        //            oDetalle.Total = Convert.ToDecimal(oDetalle.Cantidad) * oDetalle.PrecioSinImpuesto;
                ...
                //        //            oDetalle.indCalculo = true;
                //        //            oDetalle.flgIgv = false;
                //        //            oDetalle.UsuarioRegistro = oDetalle.UsuarioModificacion = VariablesLocales.SesionUsuario.Credencial;
                //        //            oDetalle.FechaRegistro = oDetalle.FechaModificacion = VariablesLocales.FechaHoy;
                ...
                //        //        txtPeriodo.Text = oPedido.Reserva;
                //        //        txtPo.Text = "0806100000";
                ...
                //        //    CanjeGuiasE Guia = new CanjeGuiasE
                //        //    {
                //        //        idDocumentoGuia = item.idDocumento,
                //        //        numSerieGuia = item.numSerie,
                //        //        numDocumentoGuia = item.numDocumento
                //        //    };
                ...
                if (!String.IsNullOrEmpty(txtRuc.Text.Trim()) && String.IsNullOrEmpty(txtRazonSocial.Text.Trim()))
                {
                    ...
                    if (oListaPersonas.Count > Variables.ValorUno)
                    {
                        ...
                        if (oFrm.ShowDialog() == DialogResult.OK && oFrm.oPersona != null)
                        {
                            ...
                            txtPais.Text = oFrm.oPersona.desPais;
                            txtDep.Text = oFrm.oPersona.desDep;
                            txtDis.Text = oFrm.oPersona.desDis;
                            txtPro.Text = oFrm.oPersona.desPro;
                        }
                        else
                        {
                    ...
                    else if (oListaPersonas.Count == 1)
                    {
                        ...
                        txtPais.Text = oListaPersonas[0].desPais;
                        txtDep.Text = oListaPersonas[0].desDep;
                        txtDis.Text = oListaPersonas[0].desDis;
                        txtPro.Text = oListaPersonas[0].desPro;
                    }
                    else
                    {
        ...
        private void chkAnticipo_CheckedChanged(object sender, EventArgs e)
        {
            ...
            btArticulos.Enabled = !chkAnticipo.Checked;
            btServicios.Enabled = !chkAnticipo.Checked;
        ...
        private void btAnticipo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (oFrm.ShowDialog() == DialogResult.OK && oFrm.oAnticipo != null)
                {
                    ...
                    Descripcion = String.Format("Aplicación Factura Anticipada {0}-{1}-{2}", oAnticipo.idDocAnticipo, oAnticipo.numSerieAnticipo, oAnticipo.numDocAnticipo);
        ...
        private void dgvDetalle_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (e.ColumnIndex == 5 && VariablesLocales.SesionUsuario.Empresa.RUC == "20452630886")//Solo si Fundo San Miguel
                {
                    Decimal Precio = Convert.ToDecimal(dgvDetalle.Rows[e.RowIndex].Cells[5].Value);

                    frmCambioPrecio oFrm = new frmCambioPrecio(Precio.ToString("N2"), "S");
                    ...
                    if (oFrm.ShowDialog() == DialogResult.OK)
                    {
                        if (!oFrm.Todos)
                        {
                            ...
                            ((EmisionDocumentoDetE)bsDetalleDocumento.Current).subTotal = oFrm.PrecioFinal * Convert.ToDecimal(((EmisionDocumentoDetE)bsDetalleDocumento.Current).Cantidad);
                            ((EmisionDocumentoDetE)bsDetalleDocumento.Current).Total = oFrm.PrecioFinal * Convert.ToDecimal(((EmisionDocumentoDetE)bsDetalleDocumento.Current).Cantidad);
                        ...
                        else
                        {
                            foreach (EmisionDocumentoDetE item in bsDetalleDocumento.List)
                            {
                                ...
                                item.subTotal = oFrm.PrecioFinal * Convert.ToDecimal(item.Cantidad);
                                item.Total = oFrm.PrecioFinal * Convert.ToDecimal(item.Cantidad);
                            }
                        }
        ...
        private void btnDistribucionCCostos_Click(object sender, EventArgs e)
        {
            if (DocumentoEmitido.ListaItemsDocumento.Count == 0)
            {
                Global.MensajeComunicacion("Debe ingresar Items antes de hacer la distribución.");
                return;
            }

            if (Convert.ToDecimal(lblTotal.Text) > 0)
            {
                Decimal Importe = Convert.ToDecimal(lblTotal.Text);
                frmEmisionDocumentoCCostos oFrm = null;

                oFrm = new frmEmisionDocumentoCCostos(Importe, DocumentoEmitido);

                if (oFrm.ShowDialog() == DialogResult.OK && oFrm.oLista.Count > Variables.Cero)
                {
                    DocumentoEmitido.ListaEmisionDocumentoCCostos = new List<EmisionDocumentoCCostosE>();
                    List<EmisionDocumentoCCostosE> oListaCCostos = oFrm.oLista;

                    foreach (EmisionDocumentoCCostosE item in oListaCCostos)
                    {
                        ...
                        DocumentoEmitido.ListaEmisionDocumentoCCostos.Add(item);
                    }
                }
            }
            else
            {
                Global.MensajeComunicacion("La distribución se realiza cuando el Total es mayor 0.00.");
            }
        }
        ...
        private void btNuevoDetalle_Click(object sender, EventArgs e)
        {
            try
            {
                List<EmisionDocumentoDetE> oListaTemp = null;
