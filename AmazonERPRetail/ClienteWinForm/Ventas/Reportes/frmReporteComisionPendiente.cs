...
{
    public partial class frmReporteComisionPendiente : FrmMantenimientoBase
    {
        #region Constructor

        public frmReporteComisionPendiente()
        {
        ...
        void LlenarCombos()
        {
            ...
            cboEstado.DataSource = Global.CargarEstadoSerie();
            ...
            ComboHelper.RellenarCombos<VendedoresE>(cboVendedor, (from x in ListaVendedores orderby x.idVendedor select x).ToList(), "idVendedor", "NombresCom", false);
        }
        ...
        void ConvertirApdf()
        {
            ...
            String NombreReporte = @"\CalculoDeComisionesPendientes";
            ...
            if (!String.IsNullOrEmpty(RutaGeneral.Trim()))
            {
                ...
                PaginaInicioComisionesPen ev = new PaginaInicioComisionesPen();
        ...
        void _bw_Dowork(object sender, DoWorkEventArgs e)
        {
            if (tipo == "buscar")
            {
                ...
                lblProcesando.Text = "Obteniendo las Comisiones Pendientes...";
                oListaComisionesCal = AgenteVentas.Proxy.ListarComisionPendientePeriodo(VariablesLocales.SesionUsuario.Empresa.IdEmpresa, Periodo, estado, Vendedor);
                lblProcesando.Text = "Armando Las Comisiones Pendientes...";
                ConvertirApdf();
            }
            else
            {
        ...
        void _bw_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                Global.MensajeComunicacion("Comisiones Pendientes Exportado...");
            }
        }
        ...
        public override void Exportar()
        {
            try
            {
                ...
                RutaGeneral = CuadrosDialogo.GuardarDocumento("Guardar en", "Comisiones Pendientes" + "-", "Archivos Excel (*.xlsx)|*.xlsx");
        ...
        void ExportarExcel(String Ruta)
        {
            ...
            TituloGeneral = " Comisiones Pendientes" + PER;
            NombrePestaña = " Comisiones Pendientes" + PER;
            ...
            using (ExcelPackage oExcel = new ExcelPackage(newFile))
            {
                ...
                if (oHoja != null)
                {
                    ...
                    // PRIMERA
                    oHoja.Cells[InicioLinea, 1].Value = "Vendedor";
        ...
        private void frmReporteComisionPendiente_Load(object sender, EventArgs e)
        {
            Grid = true;
        ...
        private void frmReporteComisionPendiente_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (_bw.IsBusy)
            {
                _bw.CancelAsync();
...
class PaginaInicioComisionesPen : PdfPageEventHelper
{
