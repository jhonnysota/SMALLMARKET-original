...
{
    public partial class frmPendientesAuxiliarVentas : frmResponseBase
    {

        #region Constructores

        public frmPendientesAuxiliarVentas()
        {
        ...
        //Viene de Planillas de Bancos
        public frmPendientesAuxiliarVentas(String Tipo_)
            :this()
        {
            Tipo = Tipo_;
        }

        //Con datos del cliente - Letras de ventas
        public frmPendientesAuxiliarVentas(Int32 idCliente, String Ruc, String RazonSocial, String Tipo_)
            :this()
        {
            ...
            if (Tipo == "CJ")
            {
                dgvDocumentosPendientes.Columns["MontoDetraFac"].Visible = true;
                dgvDocumentosPendientes.Columns["CobranzaDetra"].Visible = true;
            }
        }
        ...
        String Tipo = "CJ"; //CJ=Canje de Letras(Ventas) PL=Planilla de Bancos(Letras)  PC=Planilla de cobranza(endosadas) DV=Documentos de Ventas(Planilla de cobranza) PP=Letras para ser protestadas
        ...
        private void frmPendientesAuxiliarVentas_Load(object sender, EventArgs e)
        {
            AñadirCheckBox();
