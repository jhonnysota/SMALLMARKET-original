...
{
    public partial class frmDetallePedidoNacional : frmResponseBase
    {

        #region Constructores

        public frmDetallePedidoNacional()
        {
        ...
        public frmDetallePedidoNacional(DateTime Fecha_, PedidoDetE oLinea, List<PedidoDetE> oLista, String indCotiPedi = "P")
            :this()
        {
            FechaPedido = Fecha_;
            oDetalle = oLinea;
        ...
        //Constructor para que no haya duplicados en el detalle de los Pedidos  //NEW
        public frmDetallePedidoNacional(int Moneda_,DateTime Fecha_, List<PedidoDetE> oLista = null, String indCotiPedi = "P")
            :this()
        {
            FechaPedido = Fecha_;
            moneda = Moneda_;
        ...
        public frmDetallePedidoNacional(DateTime Fecha_, EmisionDocumentoDetE oLinea, List<EmisionDocumentoDetE> oItems, Boolean Bloqueo = true, Int32 idAlmacen = 0)
            :this()
        {
            FechaPedido = Fecha_;
        ...
        public frmDetallePedidoNacional(DateTime Fecha_, List<EmisionDocumentoDetE> oItems = null, Int32 idAlmacen = 0)
            :this()
        {
            FechaPedido = Fecha_;
        ...
        ListaPrecioItemE listaPrecioItemE = null;
        ...
        void Calcular()
        {
            ...
            if (cboImpSelectivo.SelectedValue.ToString() == "L")
            {
                ...
                Decimal Factor = (Variables.Cero * Conte) * cantLitros;
        ...
        void CalcularReves()
        {
            ...
            else if (PrecioUnitario > 0)
            {
                ...
                txtCantidad.Text = CantidadOrd.ToString("N0");
            }
        ...
        public override void Nuevo()
        {
            if (Tipo == "P" || Tipo == "C") ////////////////////////// PEDIDOS y COTIZACIONES /////////////////////////////////
            {
                if (oDetalle == null||oPedido==null)
                {
                    ...
                    cboListaPrecio.SelectedValue = moneda;
                ...
                else
                {
                    ...
                    txtLoteProveedor.Text = oDetalle.LoteProveedor;
                    txtStock.Text = oDetalle.Stock.ToString("N4");
                    cboUnidadMedida.SelectedValue = Convert.ToInt32(oDetalle.idUMedida);
                    cboListaPrecio.SelectedValue = Convert.ToInt32(oDetalle.idTipoPrecio);

                    if (txtContenido.Text == "0.00")
                    {
                        txtPrecio.Text = oDetalle.PrecioUnitario.ToString("N2");
                    }else{

                        txtPrecio.Text = oDetalle.PrecioUnitario.ToString("N2");
                    }
                    txtCantidad.Text = oDetalle.Cantidad.ToString("N0");
            ...
            else //////////////////////////////// DOCUMENTO DE EMISION //////////////////////////////////////
            {
                ...
                else
                {
                    ...
                    txtCantidad.Text = Convert.ToDecimal(oDetalleDocEmision.Cantidad).ToString("N0");
                    ...
                    cboListaPrecio.SelectedValue = Convert.ToInt32(oDetalleDocEmision.idListaPrecio);
        ...
        public override bool ValidarGrabacion()
        {
            ...
            if (((AlmacenE)cboAlmacen.SelectedItem).VerificaStock)
            {
                ...
                //{
                    ...
                    Decimal Contenido = Convert.ToDecimal(txtContenido.Text);
                    Decimal Cantidad = Variables.Cero;
                    Decimal.TryParse(txtStock.Text, out Stock);
                    Decimal.TryParse(txtCantidad.Text, out Cantidad);
                    Decimal preUni = 0;
                    ...
                    if (Contenido > 0)
                    {
                        preUni = Stock * Contenido;
                    }
                    else
                    {
                        preUni = Convert.ToDecimal(txtStock.Text);
                    }
                        ...
                        if (Cantidad > preUni)
                        {
                            Global.MensajeComunicacion("No hay stock suficiente por unidad . Escoja otro producto.");
                            txtCantidad.Focus();
                            return false;
                        }
                ...
                if (!oAlmacen.VerificaStock)
                {
                    ...
                    if (VariablesLocales.oVenParametros.indListaPrecio && Convert.ToInt32(cboListaPrecio.SelectedValue) != 0)
                    {
                        ...
                        if (oFrmBuscarArtiLista.ShowDialog() == DialogResult.OK && oFrmBuscarArtiLista.Articulo != null)
                        {
                            ...
                            cboUnidadMedida.SelectedValue = oFrmBuscarArtiLista.Articulo.codUniMedAlmacen;
                    ...
                    else
                    {
                        ...
                        if (oFrm.ShowDialog() == DialogResult.OK && oFrm.Articulo != null)
                        {
                            ...
                            txtLoteProveedor.Text = oFrm.Articulo.LoteProveedor;
                            txtStock.Text = oFrm.Articulo.Stock.ToString("N4");
                ...
                else
                {
                    if (VariablesLocales.oVenParametros.indListaPrecio && Convert.ToInt32(cboListaPrecio.SelectedValue) != 0)
                    {
                        ...
                        if (oFrmBuscarArtiLista.ShowDialog() == DialogResult.OK && oFrmBuscarArtiLista.Articulo != null)
                        {
                            ...
                            txtCodArticulo.Text = oFrmBuscarArtiLista.Articulo.codArticulo;
                            txtDesArticulo.Text = oFrmBuscarArtiLista.Articulo.nomArticulo;
                            txtLote.Text = oFrmBuscarArtiLista.Articulo.Lote;
                            txtLoteProveedor.Text = oFrmBuscarArtiLista.Articulo.LoteProveedor;
                            txtStock.Text = oFrmBuscarArtiLista.Articulo.Stock.ToString("N2");
                            cboUnidadMedida.SelectedValue = oFrmBuscarArtiLista.Articulo.codUniMedAlmacen;
                            ...
                            if (oFrmBuscarArtiLista.Articulo.indDetraccion)
                            {
                                chkDetra.Checked = oFrmBuscarArtiLista.Articulo.indDetraccion;
                                txtTipDetra.Text = oFrmBuscarArtiLista.Articulo.tipDetraccion;

                                List<TasasDetraccionesDetalleE> DetraccionDet = AgenteGeneral.Proxy.ListarDetraccionesDetActivas(FechaPedido, oFrmBuscarArtiLista.Articulo.tipDetraccion);
                    ...
                    else
                    {
                        ...
                        if (oFrmPedido.ShowDialog() == DialogResult.OK && oFrmPedido.Articulo != null)
                        {
                            ...
                            cboUnidadMedida.SelectedValue = Convert.ToInt32(oFrmPedido.Articulo.codUniMedAlmacen);
                            txtLote.Text = oFrmPedido.Articulo.Lote;
                            txtLoteProveedor.Text = oFrmPedido.Articulo.LoteProveedor;
                            txtStock.Text = oFrmPedido.Articulo.Stock.ToString("N4");
        ...
        private void btBuscarArticuloTotal_Click(object sender, EventArgs e)
        {
            try
            {
                AlmacenE oAlmacen = (AlmacenE)cboAlmacen.SelectedItem;
                String Tipo = "ArtAlmacen";
                ...
                if (oFrm.ShowDialog() == DialogResult.OK)
                {
                    ...
                    txtCapacidad.Text = oFrm.Articulo.Capacidad.ToString("N2");
                    txtContenido.Text = oFrm.Articulo.Contenido.ToString("N2");
                    txtCantidad.Text = "1.00";

                    Int32 idArticulo = oFrm.Articulo.idArticulo;
                    Int32 idListaPrecio = Convert.ToInt32(cboListaPrecio.SelectedValue);

                    ListaPrecioItemE ListaPrecioItem = AgenteVentas.Proxy.ObtenerListaPrecioItemArticulo(VariablesLocales.SesionLocal.IdEmpresa, idListaPrecio, idArticulo);

                    if (ListaPrecioItem != null)
                    {
                        if (ListaPrecioItem.idListaPrecio != 0)
                        {
                            txtPrecio.Text = ListaPrecioItem.PrecioBruto.ToString("N6");
                            txtCantidad.Text = "1.00";
                            txtPor1.Text = ListaPrecioItem.PorDscto1.ToString("N2");
                            txtDscto1.Text = ListaPrecioItem.PorDscto1.ToString("N2");
                            cboImpSelectivo.SelectedValue = ListaPrecioItem.TipoImpSelectivo.ToString();
                            txtPorIsc.Text = ListaPrecioItem.porisc.ToString("N2");
                            txtIsc.Text = ListaPrecioItem.isc.ToString("N2");
                            txtSubTotal.Text = ListaPrecioItem.PrecioBruto.ToString("N2");
                            txtValorVenta.Text = ListaPrecioItem.PrecioValorVenta.ToString("N2");
                            txtPrecioVenta.Text = ListaPrecioItem.PrecioVenta.ToString("N2");
                            txtCapacidad.Text = ListaPrecioItem.Capacidad.ToString("N2");
                            txtContenido.Text = ListaPrecioItem.Contenido.ToString("N2");
                            chkIgv.Checked = ListaPrecioItem.flgigv;

                            if (chkIgv.Checked)
                            {
                                txtPorIgv.Text = ListaPrecioItem.porigv.ToString("N2");
                                txtIgv.Text = ListaPrecioItem.igv.ToString("N2");
                            }
                            else
                            {
                                txtPorIgv.Text = "0.00";
        ...
        private void cboTipoUnidad_KeyPress(object sender, KeyPressEventArgs e)
        {
            Global.Pasar(e);
        }
        ...
        private void cboListaPrecio_SelectionChangeCommitted(object sender, EventArgs e)
        {
            try
            {
                //if (String.IsNullOrEmpty(txtIdArticulo.Text.Trim()))
                //{
                //    Global.MensajeComunicacion("Debe ingresar primero el articulo.");
                //    return;
                //}

                //ListaPrecioItemE oPrecioItem = ((ListaPrecioE)cboListaPrecio.SelectedItem).ListaPreciosItem.Find
                //(
                //    delegate(ListaPrecioItemE oPrecioTmp)
                //    {
                //        return oPrecioTmp.idArticulo == Convert.ToInt32(txtIdArticulo.Text)
                //            && oPrecioTmp.idTipoArticulo == Convert.ToInt32(((AlmacenE)cboAlmacen.SelectedItem).tipAlmacen);
                //    }
                //);

                //if (oPrecioItem != null)
                //{
                //    txtPrecio.Text = oPrecioItem.PrecioVenta.ToString("N2");
                //}
                //else
                //{
                //    txtPrecio.Text = "0.00";
