...
{
    public partial class frmNotaCreditoGenesis : FrmMantenimientoBase
    {

        public frmNotaCreditoGenesis(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
        ...
        void LlenarDatos()
        {
            ...
            if (DocumentoPrevio.idDocumentoRef == EnumTipoDocumentoVenta.FE.ToString() || DocumentoPrevio.idDocumentoRef == EnumTipoDocumentoVenta.FS.ToString() ||
        ...
        private void frmNotaCreditoGenesis_Load(object sender, EventArgs e)
        {
            try
            {
                Grid = false;
                ...
                dgvDetalle.Columns[1].Width = 502;
                dgvDetalle.Columns[2].Width = 87;
                dgvDetalle.Columns[3].Width = 73;
        ...
        private void frmNotaCreditoGenesis_Resize(object sender, EventArgs e)
        {
