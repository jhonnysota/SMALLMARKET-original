...
{
    public partial class frmNotaDebitoGenesis : FrmMantenimientoBase
    {

        public frmNotaDebitoGenesis(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
        ...
        void LlenarDatos()
        {
            ...
            Text = "Vista Previa - Nota de Débito " + Tipo + DocumentoPrevio.idDocumento + " " + DocumentoPrevio.numSerie + "-" + DocumentoPrevio.numDocumento;
        ...
        private void frmNotaDebitoGenesis_Load(object sender, EventArgs e)
        {
            try
            {
                Grid = false;
        ...
        private void frmNotaDebitoGenesis_Resize(object sender, EventArgs e)
        {
