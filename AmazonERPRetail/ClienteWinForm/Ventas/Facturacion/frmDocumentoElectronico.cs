...
{
    public partial class frmDocumentoElectronico : FrmMantenimientoBase
    {

        public frmDocumentoElectronico(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
        ...
        void LlenarDatos()
        {
            ...
            Empresa.Text = VariablesLocales.SesionUsuario.Empresa.RazonSocial;
            Direccion.Text = VariablesLocales.SesionUsuario.Empresa.Direccion;
            Ubigeo.Text = VariablesLocales.SesionUsuario.Empresa.Departamento + " " + VariablesLocales.SesionUsuario.Empresa.Provincia + " " + VariablesLocales.SesionUsuario.Empresa.Distrito;

            lblFecha.Text = Fecha.ToString("dd/MM/yyyy");

            lblRuc.Text = "RUC No " + VariablesLocales.SesionUsuario.Empresa.RUC;
            lblDocumento.Text = "FACTURA";
            lblSerie.Text = DocumentoPrevio.numSerie + "-" + DocumentoPrevio.numDocumento;            
            ...
            lblMoneda.Text = oMoneda.desMoneda.ToUpper();
                    ...
                    if (oFrm.oImpresora.PorDefecto) //Solo cuando la impresora es la principal y es matricial, se emite...
                    {
                        if (oFrm.oImpresora.EsMatricial)
                        {
                            ...
                            AgenteVentas.Proxy.CambiarEstadoDocumento(DocumentoPrevio.idEmpresa, DocumentoPrevio.idLocal, DocumentoPrevio.idDocumento, DocumentoPrevio.numSerie,
                                                                        DocumentoPrevio.numDocumento, EnumEstadoDocumentos.E.ToString(), VariablesLocales.SesionUsuario.Credencial,
