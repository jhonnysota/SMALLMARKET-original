...
{
    public partial class frmNotaCreditoInter : FrmMantenimientoBase
    {

        public frmNotaCreditoInter(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
