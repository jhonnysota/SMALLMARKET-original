...
{
    public partial class frmGuiaNevados : FrmMantenimientoBase
    {

        public frmGuiaNevados(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
            ...
            dgvDetalle.Columns[0].Width = 505;
