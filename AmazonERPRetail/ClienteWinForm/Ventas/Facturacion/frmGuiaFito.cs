...
{
    public partial class frmGuiaFito : FrmMantenimientoBase
    {

        public frmGuiaFito(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
            ...
            dgvDetalle.Columns[0].Width = 420;
            dgvDetalle.Columns[1].Width = 70;
            dgvDetalle.Columns[2].Width = 55;
            dgvDetalle.Columns[3].Width = 70;
            dgvDetalle.Columns[4].Width = 76;
        }
