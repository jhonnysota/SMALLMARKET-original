...
{
    public partial class frmBoletasEnzo : FrmMantenimientoBase
    {

        public frmBoletasEnzo(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
