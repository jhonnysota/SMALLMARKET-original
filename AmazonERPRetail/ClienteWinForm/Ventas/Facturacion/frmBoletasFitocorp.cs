...
{
    public partial class frmBoletasFitocorp : FrmMantenimientoBase
    {

        public frmBoletasFitocorp(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
        ...
        void LlenarDatos()
        {
            ...
            foreach (EmisionDocumentoDetE item in DocumentoPrevio.ListaItemsDocumento)
            {
                if (!item.indCalculo)
                {
                    item.codArticulo = item.codArticulo;
            ...
            if (DocumentoPrevio.DsctoGlobal > Variables.Cero && DocumentoPrevio.porDscto > Variables.Cero)
            {
                ...
                {
                    Cantidad = 1,
                    codArticulo = DocumentoPrevio.codArticulo,
                    nomArticulo = DocumentoPrevio.Glosa,
                    indCalculo = false,
                    TotalCad = "-" + DocumentoPrevio.DsctoGlobal.Value.ToString("N2")
                };
        ...
        private void frmBoletasFitocorp_Load(object sender, EventArgs e)
        {
            try
            {
                Grid = false;
                ...
                dgvDetalle.Columns[2].Width = 440;
        ...
        private void frmBoletasFitocorp_Resize(object sender, EventArgs e)
        {
