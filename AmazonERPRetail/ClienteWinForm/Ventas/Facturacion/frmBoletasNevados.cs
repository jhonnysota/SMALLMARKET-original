...
{
    public partial class frmBoletasNevados : FrmMantenimientoBase
    {

        public frmBoletasNevados(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
        ...
        void LlenarDatos()
        {
            ...
            lblFecEmision.Text = "Lima,    " + Fecha.ToString("dd") + "    de    " + Global.PrimeraMayuscula(FechasHelper.NombreMes(Convert.ToInt32(Fecha.ToString("MM")))) + "    de    " + Fecha.ToString("yyyy");
            ...
            foreach (EmisionDocumentoDetE item in DocumentoPrevio.ListaItemsDocumento)
            {
                    ...
                    VariablesLocales.SesionUsuario.Empresa.RUC == "20517933318") //Vivero Genesis
                {
                    ...
                    item.TotalCad = oMoneda.desAbreviatura + Global.Derecha("            " + item.TotalCad, 12);
                }
                else
                {
                    item.nomArticulo = item.nomArticulo;
            ...
            lblTotal.Text = DocumentoPrevio.totTotal.ToString("N2");
        ...
        private void frmBoletasNevados_Load(object sender, EventArgs e)
        {
            try
            {
                Grid = false;
        ...
        private void frmBoletasNevados_Resize(object sender, EventArgs e)
        {
