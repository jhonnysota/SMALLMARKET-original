...
{
    public partial class frmPrevioFacturaFitocorp : FrmMantenimientoBase
    {

        #region Constructores

        public frmPrevioFacturaFitocorp()
        {
        ...
        public frmPrevioFacturaFitocorp(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
            :this()
        {
