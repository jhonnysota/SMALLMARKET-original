...
{
    public partial class frmPrevioFacturaWSS : FrmMantenimientoBase
    {

        public frmPrevioFacturaWSS(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
