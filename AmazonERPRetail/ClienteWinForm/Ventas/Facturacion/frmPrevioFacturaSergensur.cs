...
{
    public partial class frmPrevioFacturaSergensur : FrmMantenimientoBase
    {

        #region Constructores

        public frmPrevioFacturaSergensur()
        {
        ...
        public frmPrevioFacturaSergensur(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
            :this()
        {
        ...
        void LlenarDatos()
        {
            ...
            foreach (EmisionDocumentoDetE item in DocumentoPrevio.ListaItemsDocumento)
            {
                if (VariablesLocales.SesionUsuario.Empresa.RUC == "20502647009" || //AgroGenesis
                    ...
                    VariablesLocales.SesionUsuario.Empresa.RUC == "20509606766") //Vivero Genesis
                {
        ...
        private void frmPrevioFacturaFitocorp_Resize(object sender, EventArgs e)
        {
