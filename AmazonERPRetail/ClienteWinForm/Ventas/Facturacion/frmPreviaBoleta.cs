...
{
    public partial class frmPreviaBoleta : FrmMantenimientoBase
    {

        public frmPreviaBoleta(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
        ...
        #region Eventos
        private void frmPreviaBoleta_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        void LlenarDatos()
        {
            ...
            //lvlFono.Text= DocumentoPrevio.Fono
        ...
        void pFormatoGrid(DataGridView oDgv)
        {
            ...
            oDgv.ColumnHeadersDefaultCellStyle.Font = new System.Drawing.Font("Arial", 7.25f, FontStyle.Bold, GraphicsUnit.Point);
            ...
            oDgv.RowsDefaultCellStyle.Font = new System.Drawing.Font("Arial", 7, FontStyle.Regular, GraphicsUnit.Point);
            ...
            try
            {
                ...
                if (oFrm.ShowDialog() == DialogResult.OK && oFrm.oImpresora != null)
                {
                    ...
                    if (oFrm.oImpresora.PorDefecto) //Solo cuando la impresora es la principal y es matricial, se emite...
                    {
                        ...
                        {
                            ImpresionManager.RecuperarUtilImpresion(VariablesLocales.SesionUsuario.Empresa.RUC).ImprimirBoletas(DocumentoPrevio, NombreImpresora);
