...
{
    public partial class frmFacturaGenesis : FrmMantenimientoBase
    {

        #region Constructores

        public frmFacturaGenesis()
        {
        ...
        public frmFacturaGenesis(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
            :this()
        {
        ...
        private void frmFacturaGenesis_Load(object sender, EventArgs e)
        {
            try
            {
                Grid = false;
                ...
                dgvDetalle.Columns[1].DefaultCellStyle.WrapMode = DataGridViewTriState.True;
                dgvDetalle.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.DisplayedCellsExceptHeaders;
                dgvDetalle.Columns[1].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            }
            catch (Exception ex)
            {
        ...
        private void frmFacturaGenesis_Resize(object sender, EventArgs e)
        {
