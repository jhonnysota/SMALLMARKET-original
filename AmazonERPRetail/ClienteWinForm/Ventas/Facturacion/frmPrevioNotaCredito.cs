...
{
    public partial class frmPrevioNotaCredito : FrmMantenimientoBase
    {

        public frmPrevioNotaCredito(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
        ...
        void LlenarDatos()
        {
            ...
            numIgv = Convert.ToDecimal(DocumentoPrevio.totIgv);
            lblValorVenta.Text = numDecimal.ToString("N2");
            lblPrecio.Text = "I.G.V. " + porcIgv + " %";
            lblIgv.Text = numIgv.ToString("N2");
        ...
        private void frmPrevioNotaCredito_Load(object sender, EventArgs e)
        {
            try
            {
                Grid = false;
        ...
        private void frmPrevioNotaCredito_SizeChanged(object sender, EventArgs e)
        {
