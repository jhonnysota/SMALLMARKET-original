...
{
    public partial class frmGuiaInter : FrmMantenimientoBase
    {

        public frmGuiaInter(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
            ...
            dgvDetalle.Columns[3].Width = 550;
        ...
        void LlenarDatos()
        {
            if (DocumentoPrevio != null)
            {
                ...
                if (!string.IsNullOrEmpty(DocumentoPrevio.idDocumentoRef.Trim()))
                {
                    lblOc.Text = DocumentoPrevio.numDocumentoRef;
                }
        ...
        private void frmGuiaInter_Load(object sender, EventArgs e)
        {
            Grid = false;
        ...
        private void dgvDetalle_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            QuitarLineas(e, 0, 3, TextFormatFlags.Default);
        }

        private void frmGuiaInter_Resize(object sender, EventArgs e)
        {
