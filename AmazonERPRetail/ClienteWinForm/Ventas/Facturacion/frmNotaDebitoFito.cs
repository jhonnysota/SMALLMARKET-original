...
{
    public partial class frmNotaDebitoFito : FrmMantenimientoBase
    {

        public frmNotaDebitoFito(Int32 idEmpresa, Int32 idLocal, String idDocumento, String Serie, String Numero)
        {
